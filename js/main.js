...
function initRevealOnScroll() {
  const elements = document.querySelectorAll('.service-card, .course-card, .testimonial-card, .program-card, .program-detail-card, .event-card, .journey-step, .faq-item, .benefit-card, .roadmap-step, .team-card, .story-section, .mission-section, .vision-section, .page-image, .info-cards article');
